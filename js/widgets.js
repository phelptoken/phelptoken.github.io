Function && Function.prototype && Function.prototype.bind && (/(MSIE ([6789]|10|11))|Trident/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function(t) {
            ...
            if (n) e.push(n[2]);
                ...
                u.charset = "utf-8", u.timeout = 120, i.nc && u.setAttribute("nonce", i.nc), u.src = function(t) {
                    return i.p + "js/" + ({
                        ...
                        0: "126ccbec3f6038135ffb4feab4485043",
                        2: "08de0b7088ec1c16be90781894d17119",
                        3: "5d16ecc02fbaf599a24dfb57ab239320",
                        4: "83723309ce3c4d2c320fdcaaaeee3dcd",
                        5: "161485afa4b62fc85c2a8ebd0fbbb488",
                        6: "f0018d9150722c67abdd0e6bbab13587",
                        7: "0c307910a3b82b535f15af7aa5102a10"
                    }[t] + ".js"
                }(t), s = function(e) {
    ...
    var r = n(15),
        ...
        s = n(16);
    t.exports = function(t, e, n) {
        return new r(o, i, s.TIMELINE, t, e, n)
    }
}, function(t, e, n) {
    var r = n(4),
        i = n(15),
    ...
    t.exports = {
        tweetButtonHtmlPath: "/widgets/tweet_button.58065ae230495f5d9e4b6a916472b2c1.{{lang}}.html",
        followButtonHtmlPath: "/widgets/follow_button.58065ae230495f5d9e4b6a916472b2c1.{{lang}}.html",
        hubHtmlPath: "/widgets/hub.html",
        widgetIframeHtmlPath: "/widgets/widget_iframe.58065ae230495f5d9e4b6a916472b2c1.html",
    ...
    var r, i = n(3),
        ...
        m = n(30),
        v = n(35);
    n(159), m.emitter.trigger(m.START), u.set("widgets.init", !0), a.set("init", !0), p(), r = new i, s.exposeReadyPromise(r.promise, a.base, "_e"), a.set("widgets", f), a.set("widgets.load", l.load), a.set("events", d), h(function() {
    ...
    t.exports = [n(113), n(119), n(127), n(129), n(131), n(145), n(147)]
}, function(t, e, n) {
    var r = n(11),
        i = n(5),
        o = n(0),
    ...
    t.exports = function(t) {
        t.params({
            ...
            var e, n, o = this.params.id ? {
                listId: this.params.id
            } : (e = this.params, n = r.listScreenNameAndSlug(e.url) || e, i.compact({
    ...
    var r = n(0);
    t.exports = r.aug({}, n(150), n(151), n(152), n(153), n(154), n(155), n(156))
}, function(t, e, n) {
    var r = n(60),
        i = n(17)(["userId"], {}, r);
    t.exports = {
